...
<template>
    ...
    >
        <div class="mx-auto flex w-240 flex-wrap items-start justify-between">
            ...
            <div class="m-3 font-lato text-m">
                <h4 class="mb-4 text-l">{{ t("følg-oss") }}</h4>
                <ul>
                    <li>
